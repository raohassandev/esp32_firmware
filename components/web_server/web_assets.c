...
extern const uint8_t operational_css_start[] asm("_binary_operational_css_start");
extern const uint8_t operational_css_end[] asm("_binary_operational_css_end");
...
extern const uint8_t operational_js_start[] asm("_binary_operational_js_start");
extern const uint8_t operational_js_end[] asm("_binary_operational_js_end");
...
const char *web_assets_operational_css(size_t *length) { return asset(operational_css_start, operational_css_end, length); }
...
const char *web_assets_operational_js(size_t *length) { return asset(operational_js_start, operational_js_end, length); }
