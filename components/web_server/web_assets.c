...
_binary_devices_css_start _binary_em500_css_start _binary_ota_css_start
_binary_app_js_start _binary_theme_js_start
_binary_engineering_session_resilience_js_start _binary_product_mode_js_start
...
_binary_product_shell_v2_js_start _binary_product_experience_v2_js_start
_binary_commissioning_route_js_start _binary_commissioning_wizard_v2_js_start
_binary_commissioning_release_v3_js_start _binary_engineering_errors_js_start
_binary_ui_enhancements_js_start _binary_wifi_utils_js_start
_binary_wifi_guard_js_start _binary_wifi_js_start
...
_binary_solar_grid_js_start _binary_ota_js_start
*/
...
ASSET_GETTER(web_assets_ota_css, ota_css)
...
ASSET_GETTER(web_assets_ota_js, ota_js)
