...
_binary_commissioning_release_v3_css_start _binary_ota_css_start _binary_wifi_css_start
...
_binary_commissioning_release_v3_js_start _binary_ota_js_start
...
_binary_industrial_ui_v1_js_start
*/
...
DECLARE_ASSET(shell_current_fixes_css);
DECLARE_ASSET(product_experience_v2_css);
DECLARE_ASSET(operator_continuity_verdict_css);
...
DECLARE_ASSET(industrial_ui_v1_css);
...
DECLARE_ASSET(operator_continuity_verdict_js);
...
DECLARE_ASSET(industrial_ui_v1_js);
...
ASSET_GETTER(web_assets_shell_current_fixes_css, shell_current_fixes_css)
ASSET_GETTER(web_assets_product_experience_v2_css, product_experience_v2_css)
ASSET_GETTER(web_assets_operator_continuity_verdict_css, operator_continuity_verdict_css)
...
ASSET_GETTER(web_assets_industrial_ui_v1_css, industrial_ui_v1_css)
...
ASSET_GETTER(web_assets_operator_continuity_verdict_js, operator_continuity_verdict_js)
...
ASSET_GETTER(web_assets_industrial_ui_v1_js, industrial_ui_v1_js)