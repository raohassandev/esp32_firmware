...
pvdg_ui_shell_t pvdg_ui_shell_create(lv_obj_t *parent,const pvdg_ui_shell_callbacks_t *callbacks){
    ...
    s.content=lv_obj_create(s.root); lv_obj_set_pos(s.content,PVDG_UI_SIDEBAR_W,PVDG_UI_TOPBAR_H); lv_obj_set_size(s.content,800-PVDG_UI_SIDEBAR_W,480-PVDG_UI_TOPBAR_H); pvdg_ui_style_root(s.content); lv_obj_remove_flag(s.content,LV_OBJ_FLAG_SCROLLABLE);
