...
Current `dev` snapshot: `dd10809f4246713ab99b3ccc9c3b515ece94fd0d` after governed PR #138 merge.

| Lane | Scope | State | Primary evidence / dependency |
|---|---|---|---|
| L0/L8 | Governance and live reconciliation | CONTINUOUS / HEALTHY | #79/#84/#91/#93; this reconciliation follows #138 |
...
- PR #138 — project-wide regression contract forbidding whole automatic `app_config_t` runtime stack frames -> `dd10809f4246713ab99b3ccc9c3b515ece94fd0d`; focused `33762133658`, full `33762133649` GREEN.
