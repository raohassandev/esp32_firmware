...
Current `dev` snapshot: `df282a3e8afee27dfc220694e4461e4ad49d2277` after governed PR #127 merge.

| Lane | Scope | State | Primary evidence / dependency |
|---|---|---|---|
| L0/L8 | Governance and live reconciliation | CONTINUOUS / HEALTHY | #84/#93; PR #125 plus this reconciliation |
...
- PR #127 — runtime control is force-disabled before generic config import, meter mapping, inverter mapping, or profile assignment persistence -> `df282a3e8afee27dfc220694e4461e4ad49d2277`; focused `33741274303`, full `33741274300` GREEN.

Stale replay PRs #115/#116/#118/#121/#123/#126 are closed and are not current evidence sources.
...
- Runtime configuration/mapping changes that can invalidate live control assumptions must force-disable command authority before persistence.
