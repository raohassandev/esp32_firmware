...
function stepBlocker(step){
 ...
 if(step===2){const bad=state.devices.find(d=>d.channel==='tcp'&&(!d.tcp.host||d.tcp.port<1||d.tcp.port>65535||d.tcp.unit_id<1||d.tcp.unit_id>247));return bad?`Complete valid TCP settings for ${bad.name}.`:'';}
