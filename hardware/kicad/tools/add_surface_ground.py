...
def add_zone(board,layer,netcode):
    ...
    # Dense routing can fracture a surface pour into copper fragments that touch
    # no GND pad. Those fragments are not useful return copper and were the five
    # residual GND-only ratsnest items in PR validation run 32339166203. Remove
    # them during KiCad fill; pad-connected surface copper remains and is tied
    # to the continuous L2 reference by stitch_ground_islands.py.
...
def main(board_path):
    ...
    print('SURFACE_GND_GEOMETRY: PASS solid F.Cu+B.Cu logic pours; floating islands removed; relay/MagJack exclusions retained')
